...
def on_starting(server):
    ...
    scheduler.add_job(func=status_plots.update, name="plots", trigger='interval', seconds=120, jitter=60)  
    scheduler.add_job(func=status_wallets.update, name="wallets", trigger='interval', seconds=120, jitter=60) 
    scheduler.add_job(func=status_plotnfts.update, name="plotnfts", trigger='interval', seconds=120, jitter=60) 
    scheduler.add_job(func=status_blockchains.update, name="blockchains", trigger='interval', seconds=120, jitter=60) 
    scheduler.add_job(func=status_connections.update, name="connections", trigger='interval', seconds=120, jitter=60) 
    scheduler.add_job(func=status_keys.update, name="keys", trigger='interval', seconds=120, jitter=60) 
    scheduler.add_job(func=status_alerts.update, name="alerts", trigger='interval', seconds=120, jitter=60) 
    scheduler.add_job(func=status_pools.update, name="pools", trigger='interval', seconds=120, jitter=60)
    scheduler.add_job(func=status_partials.update, name="partials", trigger='interval', seconds=120, jitter=60) 
