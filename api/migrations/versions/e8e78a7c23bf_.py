...
Revision ID: e8e78a7c23bf
Revises: a73e47f22d10
Create Date: 2022-10-01 17:19:07.495438
...
revision = 'e8e78a7c23bf'
down_revision = 'a73e47f22d10'
branch_labels = None
depends_on = None
...
def upgrade_stat_container_mem_gib():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('stat_container_mem_gib',
...
def downgrade_stat_container_mem_gib():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('stat_container_mem_gib')
    # ### end Alembic commands ###


def upgrade_stat_host_mem_pct():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('stat_host_mem_pct',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('hostname', sa.String(), nullable=True),
    sa.Column('value', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.String(), nullable=True),
