...
## [0.8.4] - 2022-09-?
- New lower memory-usage mode where blockchain wallets are synced daily, not run 24/7.  Saves ~30%-50% memory so smaller farmers can farm more blockchains concurrently on the same machine. See Wallets page, top-right.
