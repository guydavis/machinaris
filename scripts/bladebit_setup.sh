    ...
    if [ ! -f /usr/bin/bladebit ] && [[ "${bladebit_skip_build}" != 'true' ]]; then
        ...
        if [[ "${arch_name}" = "x86_64" ]] || [[ "${arch_name}" = "arm64" ]]; then
            ...
            if [[ "${arch_name}" = "x86_64" ]]; then
                curl -sLJO https://github.com/Chia-Network/bladebit/releases/download/v3.1.0-rc1/bladebit-v3.1.0-rc1-ubuntu-x86-64.tar.gz
                curl -sLJO https://github.com/Chia-Network/bladebit/releases/download/v3.1.0-rc1/bladebit-cuda-v3.1.0-rc1-ubuntu-x86-64.tar.gz
            else
                curl -sLJO https://github.com/Chia-Network/bladebit/releases/download/v3.1.0-rc1/bladebit-v3.1.0-rc1-ubuntu-arm64.tar.gz
                curl -sLJO https://github.com/Chia-Network/bladebit/releases/download/v3.1.0-rc1/bladebit-cuda-v3.1.0-rc1-ubuntu-arm64.tar.gz
            fi
