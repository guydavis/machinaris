...
if [[ "${blockchain_db_download}" == 'true' ]] \
  ...
  echo "It is recommended to add some peer node connections on the Connections page of Machinaris from: https://alltheblocks.net/wheat"
fi
