...
if [ -z ${MMX_BRANCH} ]; then
	...
	rm -rf /root/.cache
	apt-get update
	apt-get install -y sudo apt install git cmake build-essential libsecp256k1-dev librocksdb-dev libsodium-dev zlib1g-dev ocl-icd-opencl-dev clinfo screen
